...
var APP_ID = "27386157";
var API_KEY = "913W7M3DXW6O7aW9hGoWu27L";
var SECRET_KEY = "Z8GQ2QnaaGYf10qZKe3n315Hf1IWwdKG";
 
// =====下面是评分从0-100时对图片的评价,可以自行修改引号中的内容====
var dic = {
  0: "对方不想和你说话",//0-10分的评价
  1: "你的xp也太奇怪了吧喂！",//10-20分的评价
  2: "就这就这？不要小瞧色图啊混蛋！",//20-30分的评价
  3: "就这就这？可莉都比这涩！",//30-40分的评价
  4: "啧，一般",//40-50分的评价
  5: "感觉不如原神",//50-60分的评价
  6: "勉强能冲",//60-70分的评价
  7: "拿这个考验干部？？？",//70-80分的评价
  8: "达咩达咩好羞涩，人家不敢看了",//80-90分的评价
  9: "我超太涩了(//// ^ ////)快撤回别让狗管理看见！",//90-100分的评价
}

// =======设置CD开关和CD时长===============================
let isCD = false //设为false则无CD，设为true则有CD，主人不受影响
let CD = 2        //CD时长，单位分钟，最小为1
